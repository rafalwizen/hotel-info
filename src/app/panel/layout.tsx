...
export default async function PanelLayout({
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 p-4 md:flex-row md:gap-10 md:p-8">
      <aside className="flex shrink-0 flex-col gap-6 md:w-52">
      ...
      <main className="min-w-0 flex-1 space-y-6 pb-16">{children}</main>
      <Toaster richColors position="bottom-right" />
    </div>
  );
}
